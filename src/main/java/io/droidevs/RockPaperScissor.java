...
public class RockPaperScissor {
    ...
    // store the computer choice so that we can retrieve the value to diaplay it to the front end
    private String computerChoice;

    // store the score so that we can retrieve the values and display it to the frontend
